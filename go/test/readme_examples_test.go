...
const testSeed = `map[string]any{"entity": map[string]any{"generate_custom_placeholder": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "generate_rectangular_placeholder": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "generate_square_placeholder": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`

...
type ImagePlaceholderGeneratorSDK struct {
	Mode     string
...
func NewImagePlaceholderGeneratorSDK(options map[string]any) *ImagePlaceholderGeneratorSDK {
	sdk := &ImagePlaceholderGeneratorSDK{
		Mode:     "live",
		Features: []Feature{},
	}
...
func (sdk *ImagePlaceholderGeneratorSDK) OptionsMap() map[string]any {
...
func (sdk *ImagePlaceholderGeneratorSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *ImagePlaceholderGeneratorSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *ImagePlaceholderGeneratorSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ImagePlaceholderGeneratorSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *ImagePlaceholderGeneratorSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *ImagePlaceholderGeneratorSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("ImagePlaceholderGeneratorSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *ImagePlaceholderGeneratorSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ImagePlaceholderGeneratorSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("ImagePlaceholderGeneratorSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *ImagePlaceholderGeneratorSDK {
	...
	sdk := NewImagePlaceholderGeneratorSDK(sdkopts)
	sdk.Mode = "test"

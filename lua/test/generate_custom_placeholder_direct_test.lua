...
describe("GenerateCustomPlaceholderDirect", function()
  it("should direct-load-generate_custom_placeholder", function()
    local setup = generate_custom_placeholder_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-generate_custom_placeholder", setup.live and "live" or "unit")

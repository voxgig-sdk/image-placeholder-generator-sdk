...
function runner.env_override(m)
  local live = runner.getenv("IMAGE_PLACEHOLDER_GENERATOR_TEST_LIVE")
  local override = runner.getenv("IMAGE_PLACEHOLDER_GENERATOR_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("IMAGE_PLACEHOLDER_GENERATOR_TEST_EXPLAIN")

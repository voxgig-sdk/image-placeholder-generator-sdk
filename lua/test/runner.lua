...
function runner.env_override(m)
  local live = runner.getenv("IMAGEPLACEHOLDERGENERATOR_TEST_LIVE")
  local override = runner.getenv("IMAGEPLACEHOLDERGENERATOR_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("IMAGEPLACEHOLDERGENERATOR_TEST_EXPLAIN")

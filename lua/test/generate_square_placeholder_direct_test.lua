-- GenerateSquarePlaceholder direct test
...
describe("GenerateSquarePlaceholderDirect", function()
  it("should direct-load-generate_square_placeholder", function()
    local setup = generate_square_placeholder_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-generate_square_placeholder", setup.live and "live" or "unit")
...
function generate_square_placeholder_direct_setup(mockres)

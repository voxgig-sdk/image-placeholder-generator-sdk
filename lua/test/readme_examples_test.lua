...
local SDK_MODULE = "image-placeholder-generator_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["generate_custom_placeholder"] = { ["test01"] = { id = "test01" } }, ["generate_rectangular_placeholder"] = { ["test01"] = { id = "test01" } }, ["generate_square_placeholder"] = { ["test01"] = { id = "test01" } } } }'

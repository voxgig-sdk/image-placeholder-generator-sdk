...
local GenerateCustomPlaceholderEntity = {}
GenerateCustomPlaceholderEntity.__index = GenerateCustomPlaceholderEntity


function GenerateCustomPlaceholderEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GenerateCustomPlaceholderEntity)
  self._name = "generate_custom_placeholder"
  self._client = client
...
function GenerateCustomPlaceholderEntity:get_name()
  return self._name
end


function GenerateCustomPlaceholderEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GenerateCustomPlaceholderEntity.new(self._client, opts)
end
...
function GenerateCustomPlaceholderEntity:mark_deleted()
  self._deleted = true
end


function GenerateCustomPlaceholderEntity:deleted()
  return true == self._deleted
end


function GenerateCustomPlaceholderEntity:data_set(args)
  if args ~= nil then
...
function GenerateCustomPlaceholderEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GenerateCustomPlaceholderEntity:match_set(args)
  if args ~= nil then
...
function GenerateCustomPlaceholderEntity:match_get()
...
function GenerateCustomPlaceholderEntity:stream(action, args, callopts)
...
function GenerateCustomPlaceholderEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return GenerateCustomPlaceholderEntity

...
local GenerateSquarePlaceholderEntity = {}
GenerateSquarePlaceholderEntity.__index = GenerateSquarePlaceholderEntity


function GenerateSquarePlaceholderEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GenerateSquarePlaceholderEntity)
  self._name = "generate_square_placeholder"
  self._client = client
...
function GenerateSquarePlaceholderEntity:get_name()
  return self._name
end


function GenerateSquarePlaceholderEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GenerateSquarePlaceholderEntity.new(self._client, opts)
end
...
function GenerateSquarePlaceholderEntity:mark_deleted()
  self._deleted = true
end


function GenerateSquarePlaceholderEntity:deleted()
  return true == self._deleted
end


function GenerateSquarePlaceholderEntity:data_set(args)
  if args ~= nil then
...
function GenerateSquarePlaceholderEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GenerateSquarePlaceholderEntity:match_set(args)
  if args ~= nil then
...
function GenerateSquarePlaceholderEntity:match_get()
...
function GenerateSquarePlaceholderEntity:stream(action, args, callopts)
...
---@param reqmatch GenerateSquarePlaceholderLoadMatch
---@param ctrl? table
---@return GenerateSquarePlaceholder
---@return string? err
function GenerateSquarePlaceholderEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function GenerateSquarePlaceholderEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return GenerateSquarePlaceholderEntity

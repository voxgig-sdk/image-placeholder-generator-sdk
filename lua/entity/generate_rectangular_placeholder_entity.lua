...
local GenerateRectangularPlaceholderEntity = {}
GenerateRectangularPlaceholderEntity.__index = GenerateRectangularPlaceholderEntity


function GenerateRectangularPlaceholderEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GenerateRectangularPlaceholderEntity)
  self._name = "generate_rectangular_placeholder"
  self._client = client
...
function GenerateRectangularPlaceholderEntity:get_name()
  return self._name
end


function GenerateRectangularPlaceholderEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GenerateRectangularPlaceholderEntity.new(self._client, opts)
end
...
function GenerateRectangularPlaceholderEntity:mark_deleted()
  self._deleted = true
end


function GenerateRectangularPlaceholderEntity:deleted()
  return true == self._deleted
end


function GenerateRectangularPlaceholderEntity:data_set(args)
  if args ~= nil then
...
function GenerateRectangularPlaceholderEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GenerateRectangularPlaceholderEntity:match_set(args)
  if args ~= nil then
...
function GenerateRectangularPlaceholderEntity:match_get()
...
function GenerateRectangularPlaceholderEntity:stream(action, args, callopts)
...
function GenerateRectangularPlaceholderEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return GenerateRectangularPlaceholderEntity

...
The PHP SDK for the ImagePlaceholderGenerator API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->GenerateCustomPlaceholder(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->ImagePlaceholderGenerator(null)->load(
    ["id" => "test01"], null
);

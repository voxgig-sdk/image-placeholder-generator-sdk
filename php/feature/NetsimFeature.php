...
// ImagePlaceholderGenerator SDK netsim feature
...
class ImagePlaceholderGeneratorNetsimFeature extends ImagePlaceholderGeneratorBaseFeature
{
    ...
    private function _simulate(ImagePlaceholderGeneratorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ImagePlaceholderGeneratorContext $ctx, array $applied): void
    {
        $client = $this->client;

...
// ImagePlaceholderGenerator SDK metrics feature
...
class ImagePlaceholderGeneratorMetricsFeature extends ImagePlaceholderGeneratorBaseFeature
{
    ...
    private function _record(ImagePlaceholderGeneratorContext $ctx, bool $ok): void
    {

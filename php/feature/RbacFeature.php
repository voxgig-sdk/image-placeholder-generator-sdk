...
// ImagePlaceholderGenerator SDK rbac feature
...
class ImagePlaceholderGeneratorRbacFeature extends ImagePlaceholderGeneratorBaseFeature
{
    ...
    private function _required(ImagePlaceholderGeneratorContext $ctx): ?string
    {
    ...
    private function _reject(ImagePlaceholderGeneratorContext $ctx, string $required): void
    {
    ...
    private function _track(ImagePlaceholderGeneratorContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;

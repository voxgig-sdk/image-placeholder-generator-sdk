...
// ImagePlaceholderGenerator SDK paging feature
...
class ImagePlaceholderGeneratorPagingFeature extends ImagePlaceholderGeneratorBaseFeature
{
    ...
    private function _is_list(ImagePlaceholderGeneratorContext $ctx): bool
    {

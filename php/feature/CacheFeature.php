...
// ImagePlaceholderGenerator SDK cache feature
...
class ImagePlaceholderGeneratorCacheFeature extends ImagePlaceholderGeneratorBaseFeature
{
    ...
    private function _through(ImagePlaceholderGeneratorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {

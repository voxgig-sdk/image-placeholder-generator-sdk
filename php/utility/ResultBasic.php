...
// ImagePlaceholderGenerator SDK utility: result_basic

class ImagePlaceholderGeneratorResultBasic
{
    public static function call(ImagePlaceholderGeneratorContext $ctx): ?ImagePlaceholderGeneratorResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof ImagePlaceholderGeneratorError) ? $result->err->msg : (string)$result->err;

...
// ImagePlaceholderGenerator SDK utility: make_options

class ImagePlaceholderGeneratorMakeOptions
{
    ...
    public static function call(ImagePlaceholderGeneratorContext $ctx): array
    {
        ...
        //
        // `ImagePlaceholderGeneratorSchema::optspec()` is built from the model:
        ...
        $optspec = ImagePlaceholderGeneratorSchema::optspec();

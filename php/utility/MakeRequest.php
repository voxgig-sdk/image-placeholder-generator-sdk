...
// ImagePlaceholderGenerator SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ImagePlaceholderGeneratorMakeRequest
{
    public static function call(ImagePlaceholderGeneratorContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ImagePlaceholderGeneratorResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ImagePlaceholderGeneratorResponse($fetched);
        } else {

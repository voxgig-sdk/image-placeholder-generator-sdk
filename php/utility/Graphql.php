...
// ImagePlaceholderGenerator SDK utility: graphql
//
...
class ImagePlaceholderGeneratorGraphql
{
    ...
    // equivalent.
    public static function body(ImagePlaceholderGeneratorContext $ctx): mixed
    {
    ...
    public static function errors(ImagePlaceholderGeneratorContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;

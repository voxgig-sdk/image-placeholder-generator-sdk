...
// ImagePlaceholderGenerator SDK utility: make_spec

require_once __DIR__ . '/Graphql.php';

require_once __DIR__ . '/../core/Spec.php';

class ImagePlaceholderGeneratorMakeSpec
{
    public static function call(ImagePlaceholderGeneratorContext $ctx): array
    {
        ...
        if ('graphql' === \Voxgig\Struct\Struct::getprop($point, 'kind')) {
            ...
            $ctx->spec->query = [];
            $ctx->spec->headers['content-type'] = ImagePlaceholderGeneratorGraphql::CONTENT_TYPE;
        } else {

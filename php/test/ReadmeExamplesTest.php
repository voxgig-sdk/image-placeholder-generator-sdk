...
// ImagePlaceholderGenerator SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ImagePlaceholderGeneratorSDK::test)
...
{
    private const SDK_CLASS = 'ImagePlaceholderGeneratorSDK';
    ...
    private const SDK_BASE = 'imageplaceholdergenerator_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../imageplaceholdergenerator_sdk.php';
        foreach ($this->phpBlocks() as $blk) {

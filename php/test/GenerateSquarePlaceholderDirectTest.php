...
class GenerateSquarePlaceholderDirectTest extends TestCase
{
    public function test_direct_load_generate_square_placeholder(): void
    {
        $setup = generate_square_placeholder_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-generate_square_placeholder", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {

...
class ImagePlaceholderGeneratorSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = ImagePlaceholderGeneratorHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = ImagePlaceholderGeneratorHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!ImagePlaceholderGeneratorFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, ImagePlaceholderGeneratorFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return ImagePlaceholderGeneratorUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = ImagePlaceholderGeneratorHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = ImagePlaceholderGeneratorHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = ImagePlaceholderGeneratorHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new ImagePlaceholderGeneratorError($op . "_allow",
                "ImagePlaceholderGeneratorSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = ImagePlaceholderGeneratorHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new ImagePlaceholderGeneratorError("graphql_error",
                "ImagePlaceholderGeneratorSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function GenerateCustomPlaceholder($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_generate_custom_placeholder === null) {
                $this->_generate_custom_placeholder = new GenerateCustomPlaceholderEntity($this, null);
            }
            return $this->_generate_custom_placeholder;
        }
        return new GenerateCustomPlaceholderEntity($this, $data);
    }
    ...
    public function GenerateRectangularPlaceholder($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_generate_rectangular_placeholder === null) {
                $this->_generate_rectangular_placeholder = new GenerateRectangularPlaceholderEntity($this, null);
            }
            return $this->_generate_rectangular_placeholder;
        }
        return new GenerateRectangularPlaceholderEntity($this, $data);
    }
    ...
    public function GenerateSquarePlaceholder($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_generate_square_placeholder === null) {
                $this->_generate_square_placeholder = new GenerateSquarePlaceholderEntity($this, null);
            }
            return $this->_generate_square_placeholder;
        }
        return new GenerateSquarePlaceholderEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new ImagePlaceholderGeneratorSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}

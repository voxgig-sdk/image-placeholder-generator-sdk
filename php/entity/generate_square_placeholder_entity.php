...
class GenerateSquarePlaceholderEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "generate_square_placeholder";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new GenerateSquarePlaceholderEntity($this->_client, $opts);
    }

    /**
     * @param GenerateSquarePlaceholder|array $args GenerateSquarePlaceholder data (assoc-array) to store.
     */
    ...
    /**
     * @return GenerateSquarePlaceholder|array The current GenerateSquarePlaceholder data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GenerateSquarePlaceholder fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GenerateSquarePlaceholder fields).
     */
    ...
    /**
     * Load a single GenerateSquarePlaceholder.
     *
     * @param GenerateSquarePlaceholderLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GenerateSquarePlaceholderLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GenerateSquarePlaceholder|array The loaded GenerateSquarePlaceholder as an assoc-array at the

...
// ImagePlaceholderGenerator SDK GenerateCustomPlaceholder entity
...
class GenerateCustomPlaceholderEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "generate_custom_placeholder";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new GenerateCustomPlaceholderEntity($this->_client, $opts);
    }

    /**
     * @param GenerateCustomPlaceholder|array $args GenerateCustomPlaceholder data (assoc-array) to store.
     */
    ...
    /**
     * @return GenerateCustomPlaceholder|array The current GenerateCustomPlaceholder data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GenerateCustomPlaceholder fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GenerateCustomPlaceholder fields).
     */
    ...
    /**
     * Load a single GenerateCustomPlaceholder.
     *
     * @param GenerateCustomPlaceholderLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GenerateCustomPlaceholderLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GenerateCustomPlaceholder|array The loaded GenerateCustomPlaceholder as an assoc-array at the

...
// ImagePlaceholderGenerator SDK utility type

class ImagePlaceholderGeneratorUtility
{
    ...
    public static function copy(ImagePlaceholderGeneratorUtility $src): ImagePlaceholderGeneratorUtility
    {
        $u = new ImagePlaceholderGeneratorUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;

...
AQL-driven command-line client **and** interactive REPL for the ImagePlaceholderGenerator
...
- `<entity>` is a bareword, auto-quoted as an AQL atom (e.g. `generate_custom_placeholder`).

...
func registerSDKWords(r *eng.Registry, client *sdk.ImagePlaceholderGeneratorSDK) {
...
func runOp(client *sdk.ImagePlaceholderGeneratorSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {

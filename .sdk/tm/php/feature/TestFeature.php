...
// ImagePlaceholderGenerator SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class ImagePlaceholderGeneratorTestFeature extends ImagePlaceholderGeneratorBaseFeature
{
    ...
    public function init(ImagePlaceholderGeneratorContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (ImagePlaceholderGeneratorContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = ImagePlaceholderGeneratorParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (ImagePlaceholderGeneratorContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(ImagePlaceholderGeneratorContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = ImagePlaceholderGeneratorParam::call($ctx, $k);

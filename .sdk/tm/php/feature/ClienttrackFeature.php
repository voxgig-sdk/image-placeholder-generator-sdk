...
// ImagePlaceholderGenerator SDK clienttrack feature
...
class ImagePlaceholderGeneratorClienttrackFeature extends ImagePlaceholderGeneratorBaseFeature
{
    ...
    public function PostConstruct(ImagePlaceholderGeneratorContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'ImagePlaceholderGenerator-SDK';

...
// ImagePlaceholderGenerator SDK timeout feature
...
class ImagePlaceholderGeneratorTimeoutFeature extends ImagePlaceholderGeneratorBaseFeature
{
    ...
    private function _with_timeout(ImagePlaceholderGeneratorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ImagePlaceholderGeneratorContext $_ctx, float $ms): void
    {
        $client = $this->client;

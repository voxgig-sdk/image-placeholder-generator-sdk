...
// ImagePlaceholderGenerator SDK proxy feature
...
class ImagePlaceholderGeneratorProxyFeature extends ImagePlaceholderGeneratorBaseFeature
{
    ...
    public function init(ImagePlaceholderGeneratorContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ImagePlaceholderGeneratorContext $ctx2, string $url2, array $fetchdef) use ($inner): array {

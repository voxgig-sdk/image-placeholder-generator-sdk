...
// ImagePlaceholderGenerator SDK audit feature
...
class ImagePlaceholderGeneratorAuditFeature extends ImagePlaceholderGeneratorBaseFeature
{
    ...
    private function _emit(ImagePlaceholderGeneratorContext $ctx, string $outcome): void
    {

...
// ImagePlaceholderGenerator SDK streaming feature
...
class ImagePlaceholderGeneratorStreamingFeature extends ImagePlaceholderGeneratorBaseFeature
{
    ...
    private function _iterate(ImagePlaceholderGeneratorResult $result): \Generator
    {
    ...
    private function _streamable(ImagePlaceholderGeneratorContext $ctx): bool
    {

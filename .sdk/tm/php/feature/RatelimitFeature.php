...
// ImagePlaceholderGenerator SDK ratelimit feature
...
class ImagePlaceholderGeneratorRatelimitFeature extends ImagePlaceholderGeneratorBaseFeature
{
    ...
    private function _acquire(ImagePlaceholderGeneratorContext $ctx): void
    {
    ...
    private function _track(ImagePlaceholderGeneratorContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;

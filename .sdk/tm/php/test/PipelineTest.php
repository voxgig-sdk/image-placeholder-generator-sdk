...
// ImagePlaceholderGenerator SDK pipeline test
//
...
{
    private static function utility(): ImagePlaceholderGeneratorUtility
    {
        return new ImagePlaceholderGeneratorUtility();
    }
    ...
    private static function ctx(array $over = []): ImagePlaceholderGeneratorContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new ImagePlaceholderGeneratorContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new ImagePlaceholderGeneratorOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof ImagePlaceholderGeneratorError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new ImagePlaceholderGeneratorOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = ImagePlaceholderGeneratorMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new ImagePlaceholderGeneratorOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = ImagePlaceholderGeneratorMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new ImagePlaceholderGeneratorOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = ImagePlaceholderGeneratorMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ImagePlaceholderGeneratorSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = ImagePlaceholderGeneratorMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new ImagePlaceholderGeneratorResponse([]),
            'result' => new ImagePlaceholderGeneratorResult([]),
        ]);
        [, $err] = ImagePlaceholderGeneratorMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new ImagePlaceholderGeneratorSpec([]),
            'response' => null,
            'result' => new ImagePlaceholderGeneratorResult([]),
        ]);
        [, $err] = ImagePlaceholderGeneratorMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new ImagePlaceholderGeneratorSpec(['step' => 's']),
            'response' => new ImagePlaceholderGeneratorResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new ImagePlaceholderGeneratorResult([]),
        ]);
        [, $err] = ImagePlaceholderGeneratorMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new ImagePlaceholderGeneratorSpec(['step' => 's']),
            'response' => new ImagePlaceholderGeneratorResponse(self::resp(200, ['v' => 1])),
            'result' => new ImagePlaceholderGeneratorResult([]),
        ]);
        [, $err] = ImagePlaceholderGeneratorMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new ImagePlaceholderGeneratorSpec(['step' => 's']),
            'response' => new ImagePlaceholderGeneratorResponse(self::resp(200, ['v' => 2])),
            'result' => new ImagePlaceholderGeneratorResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        ImagePlaceholderGeneratorMakeResponse::call($ctx);
    ...
    {
        $preset = new ImagePlaceholderGeneratorResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new ImagePlaceholderGeneratorSpec([]),
            'response' => new ImagePlaceholderGeneratorResponse([]),
            'result' => new ImagePlaceholderGeneratorResult([]),
        ...
        [$got, $err] = ImagePlaceholderGeneratorMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new ImagePlaceholderGeneratorResult([])]);
        [, $err] = ImagePlaceholderGeneratorMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new ImagePlaceholderGeneratorSpec([]), 'result' => null]);
        [, $err] = ImagePlaceholderGeneratorMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ImagePlaceholderGeneratorSpec(['step' => 's']),
            'result' => new ImagePlaceholderGeneratorResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new ImagePlaceholderGeneratorOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ImagePlaceholderGeneratorMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ImagePlaceholderGeneratorSpec(['step' => 's']),
            'result' => new ImagePlaceholderGeneratorResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new ImagePlaceholderGeneratorOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ImagePlaceholderGeneratorMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ImagePlaceholderGeneratorResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new ImagePlaceholderGeneratorSpec([]),
            'result' => new ImagePlaceholderGeneratorResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = ImagePlaceholderGeneratorMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ImagePlaceholderGeneratorMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new ImagePlaceholderGeneratorError('boom', 'boom');
        $utility->fetcher = function (ImagePlaceholderGeneratorContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ImagePlaceholderGeneratorSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = ImagePlaceholderGeneratorMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (ImagePlaceholderGeneratorContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = ImagePlaceholderGeneratorMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(ImagePlaceholderGeneratorResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        ImagePlaceholderGeneratorMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (ImagePlaceholderGeneratorContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ImagePlaceholderGeneratorSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = ImagePlaceholderGeneratorMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new ImagePlaceholderGeneratorResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new ImagePlaceholderGeneratorSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = ImagePlaceholderGeneratorMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = ImagePlaceholderGeneratorMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = ImagePlaceholderGeneratorMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new ImagePlaceholderGeneratorResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, ImagePlaceholderGeneratorDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new ImagePlaceholderGeneratorResult(['ok' => false])]);
        $this->expectException(ImagePlaceholderGeneratorError::class);
        ImagePlaceholderGeneratorDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new ImagePlaceholderGeneratorResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', ImagePlaceholderGeneratorMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        ImagePlaceholderGeneratorMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new ImagePlaceholderGeneratorBaseFeature();
        $b = new ImagePlaceholderGeneratorBaseFeature();
        ImagePlaceholderGeneratorFeatureAdd::call($ctx, $a);
        ImagePlaceholderGeneratorFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): ImagePlaceholderGeneratorBaseFeature
    {
        $f = new ImagePlaceholderGeneratorBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        ImagePlaceholderGeneratorFeatureAdd::call($ctx, self::named_feature('a'));
        ImagePlaceholderGeneratorFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        ImagePlaceholderGeneratorFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        ImagePlaceholderGeneratorFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        ImagePlaceholderGeneratorFeatureAdd::call($ctx, $replace);
        ...
        ImagePlaceholderGeneratorFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): ImagePlaceholderGeneratorContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new ImagePlaceholderGeneratorSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ImagePlaceholderGeneratorPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        ImagePlaceholderGeneratorPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new ImagePlaceholderGeneratorResponse(['headers' => null]),
            'result' => new ImagePlaceholderGeneratorResult([]),
        ]);
        ImagePlaceholderGeneratorResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        ImagePlaceholderGeneratorResultBody::call($ctx);

...
// ImagePlaceholderGenerator SDK utility: fetcher

class ImagePlaceholderGeneratorFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ImagePlaceholderGeneratorSDK/1.0)';
    ...
    public static function call(ImagePlaceholderGeneratorContext $ctx, string $fullurl, array $fetchdef): array
    {

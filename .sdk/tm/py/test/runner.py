...
class ImagePlaceholderGeneratorTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ImagePlaceholderGeneratorTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = ImagePlaceholderGeneratorTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = ImagePlaceholderGeneratorTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")

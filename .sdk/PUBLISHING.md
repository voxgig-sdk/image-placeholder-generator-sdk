...
|---|---|---|
| `ts/` | @voxgig-sdk/image-placeholder-generator-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/image-placeholder-generator-sdk \
      --repository voxgig-sdk/image-placeholder-generator-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/image-placeholder-generator-sdk` shows it, and
`npm trust revoke @voxgig-sdk/image-placeholder-generator-sdk --id=<id>` removes it.

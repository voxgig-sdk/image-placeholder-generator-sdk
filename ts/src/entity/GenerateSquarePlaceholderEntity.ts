...
class GenerateSquarePlaceholderEntity extends ImagePlaceholderGeneratorEntityBase<GenerateSquarePlaceholder> {
  ...
  make(this: GenerateSquarePlaceholderEntity) {
    return new GenerateSquarePlaceholderEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: GenerateSquarePlaceholderLoadMatch, ctrl?: Control): Promise<GenerateSquarePlaceholderEntity> {

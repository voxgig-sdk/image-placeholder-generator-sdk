...
const ImagePlaceholderGeneratorError_1 = require("./ImagePlaceholderGeneratorError");
...
class Context {
    ...
    error(code, msg) {
        return new ImagePlaceholderGeneratorError_1.ImagePlaceholderGeneratorError(code, msg, this);
    }
    toJSON() {
        return {
            id: this.id,

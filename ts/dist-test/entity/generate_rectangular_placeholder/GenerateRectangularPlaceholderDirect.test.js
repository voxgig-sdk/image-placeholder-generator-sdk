...
(0, node_test_1.describe)('GenerateRectangularPlaceholderDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-generate_rectangular_placeholder', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-generate_rectangular_placeholder', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.IMAGE_PLACEHOLDER_GENERATOR_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    const calls = [];
    const env = (0, utility_1.envOverride)({
        'IMAGE_PLACEHOLDER_GENERATOR_TEST_GENERATE_RECTANGULAR_PLACEHOLDER_ENTID': {},
    ...
    if (live) {
        ...
        const client = new __1.ImagePlaceholderGeneratorSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['IMAGE_PLACEHOLDER_GENERATOR_TEST_GENERATE_RECTANGULAR_PLACEHOLDER_ENTID'];
...
//# sourceMappingURL=GenerateRectangularPlaceholderDirect.test.js.map
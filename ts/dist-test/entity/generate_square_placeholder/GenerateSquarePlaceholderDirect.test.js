...
(0, node_test_1.describe)('GenerateSquarePlaceholderDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-generate_square_placeholder', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-generate_square_placeholder', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['IMAGE_PLACEHOLDER_GENERATOR_TEST_GENERATE_SQUARE_PLACEHOLDER_ENTID'];
...
//# sourceMappingURL=GenerateSquarePlaceholderDirect.test.js.map
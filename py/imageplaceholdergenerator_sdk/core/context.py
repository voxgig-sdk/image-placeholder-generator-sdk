...
from imageplaceholdergenerator_sdk.core.helpers import get_ctx_prop, to_map
...
class ImagePlaceholderGeneratorContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = ImagePlaceholderGeneratorControl()
        ...
        if isinstance(sp, ImagePlaceholderGeneratorSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ImagePlaceholderGeneratorResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ImagePlaceholderGeneratorResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return ImagePlaceholderGeneratorOperation({})
    ...
    def make_error(self, code, msg):
        return ImagePlaceholderGeneratorError(code, msg, self)

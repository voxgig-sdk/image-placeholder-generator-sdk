...
class GenerateCustomPlaceholderEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GenerateCustomPlaceholderEntity(self._client, opts)
    ...
    def data_get(self) -> GenerateCustomPlaceholder:
    ...
    def match_get(self) -> GenerateCustomPlaceholder:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GenerateCustomPlaceholder:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GenerateCustomPlaceholder().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}

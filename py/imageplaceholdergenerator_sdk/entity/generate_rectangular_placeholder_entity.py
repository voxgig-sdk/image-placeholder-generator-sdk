...
from imageplaceholdergenerator_sdk.imageplaceholdergenerator_types import (
...
class GenerateRectangularPlaceholderEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GenerateRectangularPlaceholderEntity(self._client, opts)
    ...
    def data_get(self) -> GenerateRectangularPlaceholder:
    ...
    def match_get(self) -> GenerateRectangularPlaceholder:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GenerateRectangularPlaceholder:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GenerateRectangularPlaceholder().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}

...
from imageplaceholdergenerator_sdk.utility import register

# Load features
from imageplaceholdergenerator_sdk.feature.base_feature import ImagePlaceholderGeneratorBaseFeature
from imageplaceholdergenerator_sdk.features import _has_feature, _make_feature
...
class ImagePlaceholderGeneratorSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = ImagePlaceholderGeneratorUtility()
        self._utility = utility

        from imageplaceholdergenerator_sdk.config import shared_config
    ...
    def get_utility(self):
        return ImagePlaceholderGeneratorUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ImagePlaceholderGeneratorSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def GenerateCustomPlaceholder(self, data=None) -> "GenerateCustomPlaceholderEntity":
        ...
        from imageplaceholdergenerator_sdk.entity.generate_custom_placeholder_entity import GenerateCustomPlaceholderEntity
    ...
    def GenerateRectangularPlaceholder(self, data=None) -> "GenerateRectangularPlaceholderEntity":
        ...
        from imageplaceholdergenerator_sdk.entity.generate_rectangular_placeholder_entity import GenerateRectangularPlaceholderEntity
    ...
    def GenerateSquarePlaceholder(self, data=None) -> "GenerateSquarePlaceholderEntity":
        ...
        from imageplaceholdergenerator_sdk.entity.generate_square_placeholder_entity import GenerateSquarePlaceholderEntity

# ImagePlaceholderGenerator Python SDK



The Python SDK for the ImagePlaceholderGenerator API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.GenerateCustomPlaceholder()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/image-placeholder-generator-sdk/releases)) or
...
```
py/
├── imageplaceholdergenerator_sdk.py         -- Main SDK module

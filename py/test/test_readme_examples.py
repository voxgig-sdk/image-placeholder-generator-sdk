# ImagePlaceholderGenerator SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ImagePlaceholderGeneratorSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ImagePlaceholderGeneratorSDK(...) and ImagePlaceholderGeneratorSDK.test(...) become
#      ImagePlaceholderGeneratorSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "imageplaceholdergenerator_sdk"
_SDK_CLASS = "ImagePlaceholderGeneratorSDK"
...
_ENTITIES = {
    "GenerateCustomPlaceholder": "generate_custom_placeholder",
    "GenerateRectangularPlaceholder": "generate_rectangular_placeholder",
    "GenerateSquarePlaceholder": "generate_square_placeholder",
}

...
class GenerateSquarePlaceholderEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "generate_square_placeholder"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    GenerateSquarePlaceholderEntity.new(@_client, opts)
  end
  ...
  # @return [GenerateSquarePlaceholder, Hash] the current GenerateSquarePlaceholder data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of GenerateSquarePlaceholder fields)
  def match_get
  ...
  #
  # @param reqmatch [GenerateSquarePlaceholderLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.GenerateSquarePlaceholder.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [GenerateSquarePlaceholder, Hash] the loaded GenerateSquarePlaceholder; raises ImagePlaceholderGeneratorError on failure

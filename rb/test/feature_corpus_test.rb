# ImagePlaceholderGenerator SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # ImagePlaceholderGeneratorSDK.new, not ImagePlaceholderGeneratorSDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    ImagePlaceholderGeneratorSDK.new(opts)
  end

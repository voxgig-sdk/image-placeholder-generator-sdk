...
#      offline in seeded test mode (ImagePlaceholderGeneratorSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "ImagePlaceholderGenerator_sdk.rb")
  SDK_CLASS = "ImagePlaceholderGeneratorSDK"
  ...
  SDK_BASE = "ImagePlaceholderGenerator_sdk"

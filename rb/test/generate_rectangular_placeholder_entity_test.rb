...
class GenerateRectangularPlaceholderEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set IMAGEPLACEHOLDERGENERATOR_TEST_GENERATE_RECTANGULAR_PLACEHOLDER_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def generate_rectangular_placeholder_basic_setup(extra)
  ...
  entid_env_raw = ENV["IMAGEPLACEHOLDERGENERATOR_TEST_GENERATE_RECTANGULAR_PLACEHOLDER_ENTID"]

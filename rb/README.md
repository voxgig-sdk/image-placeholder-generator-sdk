# ImagePlaceholderGenerator Ruby SDK



The Ruby SDK for the ImagePlaceholderGenerator API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `ImagePlaceholderGeneratorError` (a `StandardError` subclass), so wrap
...
```
rb/
├── ImagePlaceholderGenerator_sdk.rb       -- Main SDK module
...
The main module (`ImagePlaceholderGenerator_sdk`) exports the SDK class

// Command ImagePlaceholderGenerator-mcp is an MCP server exposing the ImagePlaceholderGenerator
// SDK as MCP tools.
//
// Two tools are registered:
//
//	ImagePlaceholderGenerator_list  — list records of an entity
//	ImagePlaceholderGenerator_load  — load a single record of an entity
//

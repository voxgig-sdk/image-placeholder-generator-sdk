...
type Args struct {
	Entity string         `json:"entity" jsonschema:"generate_custom_placeholder | generate_rectangular_placeholder | generate_square_placeholder"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.ImagePlaceholderGeneratorSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "image-placeholder-generator_list",
		Description: "List records from ImagePlaceholderGenerator. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "image-placeholder-generator_load",
		Description: "Load a single record from ImagePlaceholderGenerator. " +
...
func runOp(client *sdk.ImagePlaceholderGeneratorSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ImagePlaceholderGeneratorSDK, name string) (sdk.ImagePlaceholderGeneratorEntity, error) {
	switch strings.ToLower(name) {
	case "generate_custom_placeholder":
		return client.GenerateCustomPlaceholder(nil), nil
	case "generate_rectangular_placeholder":
		return client.GenerateRectangularPlaceholder(nil), nil
	case "generate_square_placeholder":
		return client.GenerateSquarePlaceholder(nil), nil
